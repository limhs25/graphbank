library dartbank.generator.rest_crud.generator;
...
class JsonSerializableGenerator
  ...
  Future<String> generateForAnnotatedElement(Element element,
      JsonSerializable annotation, _) async {
...
String _writeAccessToVar(String varExpression, DartType searchType,
  ...
  if (_isDartDateTime(searchType)) {
    ...
    return "$varExpression == null ? null : new DateTime.fromMillisecondsSinceEpoch($varExpression)";
  }
...
ParameterizedType _typeTest(DartType type,
    bool tester(ParameterizedType type)) {
